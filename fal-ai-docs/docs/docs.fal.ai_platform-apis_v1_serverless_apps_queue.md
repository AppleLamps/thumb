---
url: "https://docs.fal.ai/platform-apis/v1/serverless/apps/queue"
title: "Queue Size - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue#content-area)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue#authorization-authorization)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue#parameter-owner)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue#parameter-name)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue#response-queue-size)
...
\\
Previous](https://docs.fal.ai/platform-apis/for-serverless) [Metrics\\
\\
Next](https://docs.fal.ai/platform-apis/v1/serverless/metrics)
