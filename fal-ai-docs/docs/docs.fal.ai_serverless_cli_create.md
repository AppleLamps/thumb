---
url: "https://docs.fal.ai/serverless/cli/create"
title: "fal create - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/create#content-area)
...
[fal doctor\\
\\
Previous](https://docs.fal.ai/serverless/cli/doctor) [fal runners\\
\\
Next](https://docs.fal.ai/serverless/cli/runners)
