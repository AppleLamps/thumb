---
url: "https://docs.fal.ai/serverless/cli/queue"
title: "fal queue - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/queue#content-area)
...
- [Size](https://docs.fal.ai/serverless/cli/queue#size)
- [Flush](https://docs.fal.ai/serverless/cli/queue#flush)
...
## [​](https://docs.fal.ai/serverless/cli/queue\#size)  Size
...
## [​](https://docs.fal.ai/serverless/cli/queue\#flush)  Flush
...
[fal run\\
\\
Previous](https://docs.fal.ai/serverless/cli/run) [fal keys\\
\\
Next](https://docs.fal.ai/serverless/cli/keys)
