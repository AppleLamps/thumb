---
url: "https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D"
title: "List files (directory) - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#content-area)
...
```
curl --request GET \
  --url https://api.fal.ai/v1/serverless/files/list/{dir} \
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#authorization-authorization)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#parameter-dir)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-path)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-name)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-created-time)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-updated-time)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-is-file)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-size)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-checksum-sha256)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/files/list/%7Bdir%7D#response-items-checksum-md5)
...
[List files (root)\\
\\
Previous](https://docs.fal.ai/platform-apis/v1/serverless/files/list) [Download file\\
\\
Next](https://docs.fal.ai/platform-apis/v1/serverless/files/file/%7Bfile%7D)
