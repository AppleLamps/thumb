---
url: "https://docs.fal.ai/platform-apis"
title: "Introduction to Platform APIs - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis#content-area)
...
\\
Access model metadata, pricing information, usage tracking, and analytics for Model APIs](https://docs.fal.ai/platform-apis/for-models) [**Platform APIs for Serverless** \\
\\
APIs to manage and monitor your serverless applications](https://docs.fal.ai/platform-apis/for-serverless) [**Platform APIs for Compute** \\
\\
Manage compute instances with lifecycle control and monitoring capabilities](https://docs.fal.ai/platform-apis/for-compute)

For executing models and generating content, see [Model APIs](https://docs.fal.ai/model-apis).
...
[Authentication\\
\\
Next](https://docs.fal.ai/platform-apis/authentication)
