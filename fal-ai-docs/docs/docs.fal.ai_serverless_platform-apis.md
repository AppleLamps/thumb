---
url: "https://docs.fal.ai/serverless/platform-apis"
title: "Platform APIs for Serverless - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/platform-apis#content-area)
...
Redirecting to [Platform APIs documentation](https://docs.fal.ai/platform-apis/for-serverless)…
...
\\
Previous](https://docs.fal.ai/serverless/python/api-reference)
