---
url: "https://docs.fal.ai/serverless/cli/apps/list"
title: "fal apps list - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/list#content-area)
...
[fal auth\\
\\
Previous](https://docs.fal.ai/serverless/cli/auth) [fal apps list-rev\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/list-rev)
