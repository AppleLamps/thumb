---
url: "https://docs.fal.ai/platform-apis/v1/serverless/logs/history"
title: "Logs history (paginated) - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#content-area)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#authorization-authorization)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-limit)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-cursor)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-one-of-0)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-app-id)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-revision)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-run-source)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-search)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-level)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-job-id)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#parameter-request-id)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#body-items-key)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#body-items-value-one-of-0)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#body-items-condition-type)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#response-next-cursor-one-of-0)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#response-has-more)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/logs/history#response-items)
...
\\
Previous](https://docs.fal.ai/platform-apis/v1/serverless/files/file/local/%7Btarget_path%7D) [Logs stream (SSE)\\
\\
Next](https://docs.fal.ai/platform-apis/v1/serverless/logs/stream)
