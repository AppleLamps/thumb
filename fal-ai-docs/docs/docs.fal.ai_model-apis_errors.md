...
title: "Error Reference - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/errors#content-area)
...
- [Error Response](https://docs.fal.ai/model-apis/errors#error-response)
- [Error Response Structure](https://docs.fal.ai/model-apis/errors#error-response-structure)
- [Headers](https://docs.fal.ai/model-apis/errors#headers)
- [Error Object Structure](https://docs.fal.ai/model-apis/errors#error-object-structure)
- [Guidance](https://docs.fal.ai/model-apis/errors#guidance)
- [Error Types](https://docs.fal.ai/model-apis/errors#error-types)
...
## [​](https://docs.fal.ai/model-apis/errors\#error-response)  Error Response
...
### [​](https://docs.fal.ai/model-apis/errors\#error-response-structure)  Error Response Structure
...
### [​](https://docs.fal.ai/model-apis/errors\#headers)  Headers
...
### [​](https://docs.fal.ai/model-apis/errors\#error-object-structure)  Error Object Structure
...
### [​](https://docs.fal.ai/model-apis/errors\#guidance)  Guidance
...
## [​](https://docs.fal.ai/model-apis/errors\#error-types)  Error Types
...
These filters are in place to ensure safe, ethical, and legal use of the platform. **The content may have been flagged by either fal’s filter or one of our partners’. Sensitivity levels can vary between partner APIs.**Violations may include, but are not limited to:
...
\\
Previous](https://docs.fal.ai/model-apis/real-time/secrets) [Platform APIs for Models\\
\\
Next](https://docs.fal.ai/model-apis/platform-apis)
