---
url: "https://docs.fal.ai/serverless/cli/installation"
title: "Installation - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/installation#content-area)
...
- [Install latest official version](https://docs.fal.ai/serverless/cli/installation#install-latest-official-version)
- [Install upstream version](https://docs.fal.ai/serverless/cli/installation#install-upstream-version)
- [Install development version from a git revision](https://docs.fal.ai/serverless/cli/installation#install-development-version-from-a-git-revision)
- [Install development version from a git tag](https://docs.fal.ai/serverless/cli/installation#install-development-version-from-a-git-tag)
- [Install development version from a git branch](https://docs.fal.ai/serverless/cli/installation#install-development-version-from-a-git-branch)

## [​](https://docs.fal.ai/serverless/cli/installation\#install-latest-official-version)  Install latest official version
...
## [​](https://docs.fal.ai/serverless/cli/installation\#install-upstream-version)  Install upstream version
...
## [​](https://docs.fal.ai/serverless/cli/installation\#install-development-version-from-a-git-revision)  Install development version from a git revision
...
## [​](https://docs.fal.ai/serverless/cli/installation\#install-development-version-from-a-git-tag)  Install development version from a git tag
...
## [​](https://docs.fal.ai/serverless/cli/installation\#install-development-version-from-a-git-branch)  Install development version from a git branch
...
\\
Previous](https://docs.fal.ai/serverless/migrations/migrate-from-replicate) [fal auth\\
\\
Next](https://docs.fal.ai/serverless/cli/auth)
