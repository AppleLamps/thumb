---
url: "https://docs.fal.ai/serverless/cli/apps/delete-rev"
title: "fal apps delete-rev - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/delete-rev#content-area)
...
[fal apps delete\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/delete) [fal deploy\\
\\
Next](https://docs.fal.ai/serverless/cli/deploy)
