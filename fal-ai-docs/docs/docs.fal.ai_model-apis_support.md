---
url: "https://docs.fal.ai/model-apis/support"
title: "Support | fal.ai Model APIs Docs - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/support#content-area)
...
- [Contact Us](https://docs.fal.ai/model-apis/support#contact-us)
- [Join Our Community](https://docs.fal.ai/model-apis/support#join-our-community)
- [Quickstart Guide](https://docs.fal.ai/model-apis/support#quickstart-guide)

## [​](https://docs.fal.ai/model-apis/support\#contact-us)  Contact Us

If you need assistance, please reach out to us at [support@fal.ai](mailto:support@fal.ai).

## [​](https://docs.fal.ai/model-apis/support\#join-our-community)  Join Our Community

Join our Discord community for discussions and updates: [Discord](https://discord.com/invite/fal-ai).

## [​](https://docs.fal.ai/model-apis/support\#quickstart-guide)  Quickstart Guide

New to fal.ai? Check out our [Quickstart Guide](https://docs.fal.ai/serverless/getting-started/quick-start) to get started quickly.
...
\\
Previous](https://docs.fal.ai/model-apis/faq)
