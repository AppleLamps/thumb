---
url: "https://docs.fal.ai/serverless/cli/auth"
title: "fal auth - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/auth#content-area)
...
- [Login](https://docs.fal.ai/serverless/cli/auth#login)
- [Logout](https://docs.fal.ai/serverless/cli/auth#logout)
- [Whoami](https://docs.fal.ai/serverless/cli/auth#whoami)
...
## [​](https://docs.fal.ai/serverless/cli/auth\#login)  Login
...
## [​](https://docs.fal.ai/serverless/cli/auth\#logout)  Logout
...
## [​](https://docs.fal.ai/serverless/cli/auth\#whoami)  Whoami
...
[Installation\\
\\
Previous](https://docs.fal.ai/serverless/cli/installation) [fal apps list\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/list)
