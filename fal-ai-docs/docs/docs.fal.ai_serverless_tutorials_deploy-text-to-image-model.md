---
url: "https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model"
title: "Deploy a Text-to-Image Model - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#content-area)
...
- [🚀 Try this Example](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#%F0%9F%9A%80-try-this-example)
- [Key Features](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#key-features)
- [Project Structure](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#project-structure)
- [Input Models](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#input-models)
- [Output Models](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#output-models)
- [Main Application Class](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#main-application-class)
- [Shared Generation Logic](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#shared-generation-logic)
- [Endpoint Definitions](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#endpoint-definitions)
- [Running the Application](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#running-the-application)
- [Development](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#development)
- [Using pyproject.toml](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#using-pyproject-toml)
- [Testing Your Endpoints](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#testing-your-endpoints)
- [Best Practices Demonstrated](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#best-practices-demonstrated)
- [Key Takeaways](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model#key-takeaways)
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#%F0%9F%9A%80-try-this-example)  🚀 Try this Example

View the complete source code on [GitHub](https://github.com/fal-ai-community/fal-demos/blob/main/fal_demos/image/sana.py).**Steps to run:**
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#key-features)  Key Features
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#project-structure)  Project Structure
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#input-models)  Input Models
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#output-models)  Output Models
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#main-application-class)  Main Application Class
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#shared-generation-logic)  Shared Generation Logic
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#endpoint-definitions)  Endpoint Definitions
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#running-the-application)  Running the Application

### [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#development)  Development
...
### [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#using-pyproject-toml)  Using pyproject.toml
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#testing-your-endpoints)  Testing Your Endpoints
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#best-practices-demonstrated)  Best Practices Demonstrated
...
## [​](https://docs.fal.ai/serverless/tutorials/deploy-text-to-image-model\#key-takeaways)  Key Takeaways
...
[Core Concepts\\
\\
Previous](https://docs.fal.ai/serverless/getting-started/core-concepts) [Deploy a Text-to-Video Model\\
\\
Next](https://docs.fal.ai/serverless/tutorials/deploy-text-to-video-model)
