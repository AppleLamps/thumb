---
url: "https://docs.fal.ai/platform-apis/for-compute"
title: "Platform APIs for Compute - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/for-compute#content-area)
...
- [Available Operations](https://docs.fal.ai/platform-apis/for-compute#available-operations)
...
## [​](https://docs.fal.ai/platform-apis/for-compute\#available-operations)  Available Operations

The Platform APIs provide the following endpoints for managing Compute instances:

[**List Instances** \\
\\
List all compute instances with their current status and configuration](https://docs.fal.ai/platform-apis/v1/compute/instances/list) [**Get Instance Details** \\
\\
Retrieve detailed information about a specific compute instance](https://docs.fal.ai/platform-apis/v1/compute/instances/get) [**Create Instance** \\
\\
Create and provision a new compute instance](https://docs.fal.ai/platform-apis/v1/compute/instances/create) [**Delete Instance** \\
\\
Terminate and remove a compute instance](https://docs.fal.ai/platform-apis/v1/compute/instances/delete)

These APIs are for **platform management** of Compute instances. For getting started with Compute, see the [Compute documentation](https://docs.fal.ai/compute).
...
[Logs stream (SSE)\\
\\
Previous](https://docs.fal.ai/platform-apis/v1/serverless/logs/stream) [List Compute Instances\\
\\
Next](https://docs.fal.ai/platform-apis/v1/compute/instances/list)
