---
url: "https://docs.fal.ai/serverless/cli/keys"
title: "fal keys - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/keys#content-area)
...
- [Create](https://docs.fal.ai/serverless/cli/keys#create)
- [List](https://docs.fal.ai/serverless/cli/keys#list)
- [Revoke](https://docs.fal.ai/serverless/cli/keys#revoke)
...
## [​](https://docs.fal.ai/serverless/cli/keys\#create)  Create
...
## [​](https://docs.fal.ai/serverless/cli/keys\#list)  List
...
## [​](https://docs.fal.ai/serverless/cli/keys\#revoke)  Revoke
...
[fal queue\\
\\
Previous](https://docs.fal.ai/serverless/cli/queue) [fal profile\\
\\
Next](https://docs.fal.ai/serverless/cli/profile)
