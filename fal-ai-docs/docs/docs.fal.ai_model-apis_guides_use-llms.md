---
url: "https://docs.fal.ai/model-apis/guides/use-llms"
title: "Use LLMs Tutorial - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/guides/use-llms#content-area)
...
- [How to select LLM model to use](https://docs.fal.ai/model-apis/guides/use-llms#how-to-select-llm-model-to-use)
...
## [​](https://docs.fal.ai/model-apis/guides/use-llms\#how-to-select-llm-model-to-use)  How to select LLM model to use
