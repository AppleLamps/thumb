---
url: "https://docs.fal.ai/serverless/deployment-operations/monitor-performance"
title: "Monitor Performance - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/deployment-operations/monitor-performance#content-area)
...
- [Using the Dashboard](https://docs.fal.ai/serverless/deployment-operations/monitor-performance#using-the-dashboard)
- [Viewing Logs](https://docs.fal.ai/serverless/deployment-operations/monitor-performance#viewing-logs)
- [Monitoring Webhooks](https://docs.fal.ai/serverless/deployment-operations/monitor-performance#monitoring-webhooks)
- [Exporting Metrics](https://docs.fal.ai/serverless/deployment-operations/monitor-performance#exporting-metrics)

## [​](https://docs.fal.ai/serverless/deployment-operations/monitor-performance\#using-the-dashboard)  Using the Dashboard

fal provides a dashboard for you to monitor your fal applications requests and logs. Go to the [fal dashboard](https://fal.ai/dashboard) to view your applications.

## [​](https://docs.fal.ai/serverless/deployment-operations/monitor-performance\#viewing-logs)  Viewing Logs

You can view the logs for your fal applications on their respective pages or in the [logs dashboard](https://fal.ai/dashboard/logs).

## [​](https://docs.fal.ai/serverless/deployment-operations/monitor-performance\#monitoring-webhooks)  Monitoring Webhooks

To view the webhooks that were triggered for your fal applications, go to the [webhooks dashboard](https://fal.ai/dashboard/webhooks).

## [​](https://docs.fal.ai/serverless/deployment-operations/monitor-performance\#exporting-metrics)  Exporting Metrics

Metrics for your fal applications can be scraped in Prometheus format. Use the [Platform APIs for Serverless](https://docs.fal.ai/platform-apis/for-serverless) to export your application metrics programmatically.
...
\\
Previous](https://docs.fal.ai/serverless/deployment-operations/manage-secrets-securely) [Scale Your Application\\
\\
Next](https://docs.fal.ai/serverless/deployment-operations/scale-your-application)
