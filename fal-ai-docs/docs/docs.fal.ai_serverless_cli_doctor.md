---
url: "https://docs.fal.ai/serverless/cli/doctor"
title: "fal doctor - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/doctor#content-area)
...
[fal secrets\\
\\
Previous](https://docs.fal.ai/serverless/cli/secrets) [fal create\\
\\
Next](https://docs.fal.ai/serverless/cli/create)
