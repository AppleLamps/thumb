---
url: "https://docs.fal.ai/platform-apis/v1/models/analytics"
title: "Analytics - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/v1/models/analytics#content-area)
...
```
curl --request GET \
  --url 'https://api.fal.ai/v1/models/analytics?timezone=UTC&bound_to_timeframe=true' \
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#authorization-authorization)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-limit)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-cursor)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-one-of-0)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-timezone)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-timeframe)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#parameter-bound-to-timeframe)
...
default:\["time\_series","request\_count"\]

Data and metrics to include in the response. Use 'time\_series' for time-bucketed data, metric names for specific metrics in time series, and 'summary' for aggregate statistics. At least one of 'time\_series' or 'summary' and at least one metric are required.
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#response-next-cursor-one-of-0)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#response-has-more)
...
[​](https://docs.fal.ai/platform-apis/v1/models/analytics#response-time-series)

time\_series

object\[\]

Time series analytics data grouped by time bucket (when expand includes 'time\_series'). Each bucket contains all analytics records for that time period.

Showchild attributes

[​](https://docs.fal.ai/platform-apis/v1/models/analytics#response-summary)
...
[Usage\\
\\
Previous](https://docs.fal.ai/platform-apis/v1/models/usage) [Delete request payloads\\
\\
Next](https://docs.fal.ai/platform-apis/v1/models/requests/payloads)
