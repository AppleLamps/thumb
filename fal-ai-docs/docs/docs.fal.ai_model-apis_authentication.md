---
url: "https://docs.fal.ai/model-apis/authentication"
title: "Authentication Authentication | fal.ai Model APIs Docs - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/authentication#content-area)
...
[**GitHub Authentication**](https://docs.fal.ai/model-apis/authentication/github) [**Key-Based Authentication**](https://docs.fal.ai/model-apis/authentication/key-based)
...
[Client Libraries\\
\\
Previous](https://docs.fal.ai/model-apis/client) [Key-Based Authentication\\
\\
Next](https://docs.fal.ai/model-apis/authentication/key-based)
