---
url: "https://docs.fal.ai/serverless/cli/apps/list-rev"
title: "fal apps list-rev - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/list-rev#content-area)
...
[fal apps list\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/list) [fal apps set-rev\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/set-rev)
