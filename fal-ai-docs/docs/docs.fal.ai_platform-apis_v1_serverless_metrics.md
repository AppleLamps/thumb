---
url: "https://docs.fal.ai/platform-apis/v1/serverless/metrics"
title: "Metrics - fal"
---

[Skip to main content](https://docs.fal.ai/platform-apis/v1/serverless/metrics#content-area)
...
[​](https://docs.fal.ai/platform-apis/v1/serverless/metrics#authorization-authorization)
...
[Queue Size\\
\\
Previous](https://docs.fal.ai/platform-apis/v1/serverless/apps/queue) [List files (root)\\
\\
Next](https://docs.fal.ai/platform-apis/v1/serverless/files/list)
