---
url: "https://docs.fal.ai/model-apis/guides/generate-images-from-text"
title: "Generate Images from Text Tutorial - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/guides/generate-images-from-text#content-area)
...
- [How to Generate Images using the fal API](https://docs.fal.ai/model-apis/guides/generate-images-from-text#how-to-generate-images-using-the-fal-api)
- [How to select the model to use](https://docs.fal.ai/model-apis/guides/generate-images-from-text#how-to-select-the-model-to-use)

## [​](https://docs.fal.ai/model-apis/guides/generate-images-from-text\#how-to-generate-images-using-the-fal-api)  How to Generate Images using the fal API

To generate images using the fal API, you need to send a request to the appropriate endpoint with the desired input parameters. The API uses pre-trained models to generate images based on the provided text prompt. This allows you to create images by simply describing what you want in natural language.Here’s an example of how to generate an image using the fal API from text:
...
## [​](https://docs.fal.ai/model-apis/guides/generate-images-from-text\#how-to-select-the-model-to-use)  How to select the model to use
...
[Quickstart\\
\\
Previous](https://docs.fal.ai/model-apis/quickstart) [Generate Videos from Image Tutorial\\
\\
Next](https://docs.fal.ai/model-apis/guides/generate-videos-from-image)
