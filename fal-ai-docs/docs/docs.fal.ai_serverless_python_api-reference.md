---
url: "https://docs.fal.ai/serverless/python/api-reference"
title: "Python SDK API Reference - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/python/api-reference#content-area)
...
For the complete Python API surface, see the auto-generated API reference:

- [fal Python SDK — Full API Reference](https://fal-ai.github.io/fal/sdk/)

You can also browse the source code on GitHub:

- [fal — Source Code](https://github.com/fal-ai/fal)
...
\\
Previous](https://docs.fal.ai/serverless/python/client) [Platform APIs for Serverless\\
\\
Next](https://docs.fal.ai/serverless/platform-apis)
