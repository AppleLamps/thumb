---
url: "https://docs.fal.ai/serverless/cli/files"
title: "fal files - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/files#content-area)
...
- [List](https://docs.fal.ai/serverless/cli/files#list)
- [Download](https://docs.fal.ai/serverless/cli/files#download)
- [Upload](https://docs.fal.ai/serverless/cli/files#upload)
- [Upload URL](https://docs.fal.ai/serverless/cli/files#upload-url)
- [Move](https://docs.fal.ai/serverless/cli/files#move)
- [Remove](https://docs.fal.ai/serverless/cli/files#remove)
...
## [​](https://docs.fal.ai/serverless/cli/files\#list)  List
...
## [​](https://docs.fal.ai/serverless/cli/files\#download)  Download
...
## [​](https://docs.fal.ai/serverless/cli/files\#upload)  Upload
...
## [​](https://docs.fal.ai/serverless/cli/files\#upload-url)  Upload URL
...
## [​](https://docs.fal.ai/serverless/cli/files\#move)  Move
...
## [​](https://docs.fal.ai/serverless/cli/files\#remove)  Remove
...
[fal deploy\\
\\
Previous](https://docs.fal.ai/serverless/cli/deploy) [fal run\\
\\
Next](https://docs.fal.ai/serverless/cli/run)
