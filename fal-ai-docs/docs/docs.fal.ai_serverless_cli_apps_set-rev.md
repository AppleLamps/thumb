---
url: "https://docs.fal.ai/serverless/cli/apps/set-rev"
title: "fal apps set-rev - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/set-rev#content-area)
...
[fal apps list-rev\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/list-rev) [fal apps rollout\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/rollout)
