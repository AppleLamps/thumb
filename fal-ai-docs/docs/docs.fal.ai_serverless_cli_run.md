---
url: "https://docs.fal.ai/serverless/cli/run"
title: "fal run - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/run#content-area)
...
[fal files\\
\\
Previous](https://docs.fal.ai/serverless/cli/files) [fal queue\\
\\
Next](https://docs.fal.ai/serverless/cli/queue)
