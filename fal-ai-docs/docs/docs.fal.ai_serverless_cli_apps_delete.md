---
url: "https://docs.fal.ai/serverless/cli/apps/delete"
title: "fal apps delete - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/delete#content-area)
...
[fal apps runners\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/runners) [fal apps delete-rev\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/delete-rev)
