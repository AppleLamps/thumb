---
url: "https://docs.fal.ai/serverless/cli/apps/runners"
title: "fal apps runners - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/runners#content-area)
...
[fal apps scale\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/scale) [fal apps delete\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/delete)
