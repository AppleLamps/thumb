---
url: "https://docs.fal.ai/serverless/cli/apps/scale"
title: "fal apps scale - fal"
---

[Skip to main content](https://docs.fal.ai/serverless/cli/apps/scale#content-area)
...
- fal apps
  ...
  - [fal apps list](https://docs.fal.ai/serverless/cli/apps/list)
  - [fal apps list-rev](https://docs.fal.ai/serverless/cli/apps/list-rev)
  - [fal apps set-rev](https://docs.fal.ai/serverless/cli/apps/set-rev)
  - [fal apps rollout](https://docs.fal.ai/serverless/cli/apps/rollout)
  - [fal apps scale](https://docs.fal.ai/serverless/cli/apps/scale)
  - [fal apps runners](https://docs.fal.ai/serverless/cli/apps/runners)
  - [fal apps delete](https://docs.fal.ai/serverless/cli/apps/delete)
  - [fal apps delete-rev](https://docs.fal.ai/serverless/cli/apps/delete-rev)
...
**Note:**Redeploying the application, by default, will not reset these settings, except for the code-specific settings. See [Code-Specific Settings (Reset on Deploy)](https://docs.fal.ai/serverless/deployment-operations/scale-your-application#code-specific-settings-reset-on-deploy) for details.
...
[fal apps rollout\\
\\
Previous](https://docs.fal.ai/serverless/cli/apps/rollout) [fal apps runners\\
\\
Next](https://docs.fal.ai/serverless/cli/apps/runners)
