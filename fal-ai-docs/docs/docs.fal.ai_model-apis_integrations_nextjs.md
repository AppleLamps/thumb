---
url: "https://docs.fal.ai/model-apis/integrations/nextjs"
title: "Add fal.ai to your Next.js app Integration - fal"
---

[Skip to main content](https://docs.fal.ai/model-apis/integrations/nextjs#content-area)
...
- [You will learn how to:](https://docs.fal.ai/model-apis/integrations/nextjs#you-will-learn-how-to%3A)
- [Prerequisites](https://docs.fal.ai/model-apis/integrations/nextjs#prerequisites)
- [1\. Install the fal.ai libraries](https://docs.fal.ai/model-apis/integrations/nextjs#1-install-the-fal-ai-libraries)
- [2\. Setup the proxy](https://docs.fal.ai/model-apis/integrations/nextjs#2-setup-the-proxy)
- [2.1. Page Router](https://docs.fal.ai/model-apis/integrations/nextjs#2-1-page-router)
- [2.2. App Router](https://docs.fal.ai/model-apis/integrations/nextjs#2-2-app-router)
- [2.3. Setup the API Key](https://docs.fal.ai/model-apis/integrations/nextjs#2-3-setup-the-api-key)
- [2.4. Custom proxy logic](https://docs.fal.ai/model-apis/integrations/nextjs#2-4-custom-proxy-logic)
- [3\. Configure the client](https://docs.fal.ai/model-apis/integrations/nextjs#3-configure-the-client)
- [4\. Generate an image](https://docs.fal.ai/model-apis/integrations/nextjs#4-generate-an-image)
- [What’s next?](https://docs.fal.ai/model-apis/integrations/nextjs#what%E2%80%99s-next)

## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#you-will-learn-how-to:)  You will learn how to:
...
## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#prerequisites)  Prerequisites
...
## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#1-install-the-fal-ai-libraries)  1\. Install the fal.ai libraries
...
## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#2-setup-the-proxy)  2\. Setup the proxy
...
### [​](https://docs.fal.ai/model-apis/integrations/nextjs\#2-1-page-router)  2.1. Page Router
...
### [​](https://docs.fal.ai/model-apis/integrations/nextjs\#2-2-app-router)  2.2. App Router
...
### [​](https://docs.fal.ai/model-apis/integrations/nextjs\#2-3-setup-the-api-key)  2.3. Setup the API Key
...
### [​](https://docs.fal.ai/model-apis/integrations/nextjs\#2-4-custom-proxy-logic)  2.4. Custom proxy logic

It’s common for applications to execute custom logic before or after the proxy handler. For example, you may want to add a custom header to the request, or log the request and response, or apply some rate limit. The good news is that the proxy implementation is simply a standard Next.js API/route handler function, which means you can compose it with other handlers.For example, let’s assume you want to add some analytics and apply some rate limit to the proxy handler:
...
Note that the URL that will be forwarded to server is available as a header named `x-fal-target-url`. Also, keep in mind the example above is just an example, `rateLimiter` and `analytics` are just placeholders.The example above used the app router, but the same logic can be applied to the page router and its `handler` function.

## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#3-configure-the-client)  3\. Configure the client
...
**Protect your API Key**Although the client can be configured with credentials, use that only for rapid prototyping. We recommend you always use the proxy to avoid exposing your API Key in the client before you deploy your web application. See the [server-side guide](https://docs.fal.ai/model-apis/model-endpoints/server-side) for more details.

## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#4-generate-an-image)  4\. Generate an image
...
## [​](https://docs.fal.ai/model-apis/integrations/nextjs\#what%E2%80%99s-next)  What’s next?
...
- Learn how to write your own model APIs on [Introduction to serverless functions](https://docs.fal.ai/serverless)
- Read more about function endpoints on [private serverless models](https://docs.fal.ai/serverless)
- Check the next page to learn how to [deploy your app to Vercel](https://docs.fal.ai/model-apis/integrations/vercel)
...
\\
Previous](https://docs.fal.ai/model-apis/authentication/github) [Add fal.ai to your Next.js app Integration\\
\\
Next](https://docs.fal.ai/model-apis/integrations/vercel)
