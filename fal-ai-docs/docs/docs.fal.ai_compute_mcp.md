---
url: "https://docs.fal.ai/compute/mcp"
title: "Connect fal to Cursor - fal"
---

[Skip to main content](https://docs.fal.ai/compute/mcp#content-area)
...
- [Connect fal to Cursor with MCP](https://docs.fal.ai/compute/mcp#connect-fal-to-cursor-with-mcp)
- [Step 1: Open Command Palette](https://docs.fal.ai/compute/mcp#step-1%3A-open-command-palette)
- [Step 2: Search for MCP Settings](https://docs.fal.ai/compute/mcp#step-2%3A-search-for-mcp-settings)
- [Step 3: Add Custom MCP](https://docs.fal.ai/compute/mcp#step-3%3A-add-custom-mcp)
- [Step 4: Configure fal Server](https://docs.fal.ai/compute/mcp#step-4%3A-configure-fal-server)
- [What You Can Do With MCP](https://docs.fal.ai/compute/mcp#what-you-can-do-with-mcp)
- [What is MCP?](https://docs.fal.ai/compute/mcp#what-is-mcp)
- [Need Help?](https://docs.fal.ai/compute/mcp#need-help)

## [​](https://docs.fal.ai/compute/mcp\#connect-fal-to-cursor-with-mcp)  Connect fal to Cursor with MCP
...
### [​](https://docs.fal.ai/compute/mcp\#step-1:-open-command-palette)  Step 1: Open Command Palette

On Cursor, use `Cmd+Shift+P` (`Ctrl+Shift+P` on Windows) to open up the command palette.

### [​](https://docs.fal.ai/compute/mcp\#step-2:-search-for-mcp-settings)  Step 2: Search for MCP Settings

Search for “Open MCP settings”.

### [​](https://docs.fal.ai/compute/mcp\#step-3:-add-custom-mcp)  Step 3: Add Custom MCP

Select **Add custom MCP**. This will open the `mcp.json` file.

### [​](https://docs.fal.ai/compute/mcp\#step-4:-configure-fal-server)  Step 4: Configure fal Server
...
## [​](https://docs.fal.ai/compute/mcp\#what-you-can-do-with-mcp)  What You Can Do With MCP
...
## [​](https://docs.fal.ai/compute/mcp\#what-is-mcp)  What is MCP?
...
## [​](https://docs.fal.ai/compute/mcp\#need-help)  Need Help?
...
\\
Previous](https://docs.fal.ai/compute) [Quickstart with Compute\\
\\
Next](https://docs.fal.ai/compute/quickstart)
