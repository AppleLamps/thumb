---
url: "https://docs.fal.ai/serverless"
title: "Introduction to Serverless - fal"
---

[Skip to main content](https://docs.fal.ai/serverless#content-area)
...
- [Key Features](https://docs.fal.ai/serverless#key-features)
...
[**Quick Start** \\
\\
Deploy your first model in minutes with our step-by-step guide.](https://docs.fal.ai/serverless/getting-started/quick-start) [**Migrate in 5 Minutes** \\
\\
Already have a Docker server? Migrate it to fal with minimal changes.](https://docs.fal.ai/serverless/migrations/migrate-external-docker-server)

## [​](https://docs.fal.ai/serverless\#key-features)  Key Features

1. **Instant scaling**: Start from zero to thousands of GPUs instantly
2. **Pay-per-use**: Pay only for the compute you use with auto-scaling and high availability
3. **Unified framework**: Complete solution for running, deploying, and productionizing your AI apps
4. **GPU access**: Access to thousands of H100s, H200s, and other high-performance GPUs
5. **Full observability**: Complete visibility into requests, responses, and latencies (including custom metrics)
6. **Native clients**: HTTP and WebSocket clients that work with both fal-provided models and your own apps
...
\\
Next](https://docs.fal.ai/serverless/mcp)
